...
หมายเหตุ v0.2.1: ยุบเอกสารให้เหลือ `README.md` ไฟล์เดียวแล้ว
...
git commit -m "Release v0.2.1 single README"
git push
```
...
[ ] เปิด index.html ได้
[ ] เพิ่มลูกค้าได้
[ ] ตั้งค่า Web App URL + token ได้
[ ] กด Initialize Sheets แล้ว Google Sheet มี tabs ครบ
[ ] คีย์เที่ยววิ่งรถบริษัทได้
...
```text
Base: v0.2.1-google-sheets
Current: v0.2.1-google-sheets
```
